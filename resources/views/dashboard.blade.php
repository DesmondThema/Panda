    ...
    <div>
        <div class="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
            <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-indigo-600 px-6">
                <div class="flex h-16 shrink-0 items-center">
                    <a href="{{ url('/') }}">
                        <img class="h-8 w-auto" src="https://www.joinpanda.com/img/logo/128x128.png" alt="Panda">
                    </a>
                </div>
        ...
        <main class="py-10 lg:pl-72">
            <div class="px-4 sm:px-6 lg:px-8">
                <h1 class="text-black font-bold text-3xl">Dashboard</h1>
                <div>
                    <dl class="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-3">
                        ...
                        <div class="overflow-hidden rounded-lg bg-white px-4 py-5 shadow sm:p-6">
                            <dt class="truncate text-sm font-medium text-gray-500">Total Highlights</dt>
                            <dd class="mt-1 text-3xl font-semibold tracking-tight text-gray-900">{{ $totalHighlights }}</dd>
                        </div>
                    </dl>
                </div>
                <div class="h-1/4 w-1/2">
                    <livewire:statistics />
                </div>
                <h1 class="text-black font-bold text-3xl mt-4 mb-4">Upcoming Sessions</h1>
                <div class="mt-4">
